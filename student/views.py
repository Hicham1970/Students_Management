...
def add_student(request):
    if request.method == "POST":
        ...
        create_notification(
            request.user, f"Added Student: {student.first_name} {student.last_name}")
        messages.success(
...
def edit_student(request, slug):
    ...
    if request.method == "POST":
        ...
        admission_number = request.POST.get('admission_number')
        section = request.POST.get('section')
        student_image = request.FILES.get('student_image') if request.FILES.get(
            'student_image') else student.student_image
...
#  update student information
        ...
        create_notification(
            request.user, f"Edited Student: {student.first_name} {student.last_name}")
