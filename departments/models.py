...
from teachers.models import Teacher  # Import du modèle Teacher pour relier au chef de département
...
class Department(models.Model):
    ...
    dept_head = models.OneToOneField(Teacher, on_delete=models.SET_NULL, null=True, blank=True, related_name='department_head', verbose_name="Chef de département")
    ...
    # Slug pour les URLs (ajouté pour cohérence avec Teacher)
    slug = models.SlugField(max_length=255, unique=True, blank=True, verbose_name="Slug")
    
    # Relations potentielles (décommentez si les apps existent)
    ...
    class Meta:
        ...
        ordering = ['dept_name']  # Corrigé pour utiliser dept_name
    ...
    def __str__(self):
        return f"{self.dept_code} - {self.dept_name}" if self.dept_code else self.dept_name  # Corrigé pour utiliser dept_code et dept_name